...
class MyFlutterDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: MynewApp());
  }
}
...
class _MynewAppState extends State<MynewApp> {
  ...
  Color myContainerColor = Colors.red;
  @override
  Widget build(BuildContext context) {
    // List<Container> list = [];
    return Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  myContainer(Colors.red, "Click red", () {
                    setState(() {
                      myContainerColor = Colors.red;
                    });
                  }),
                  myContainer(Colors.yellow, "Click yellow", () {
                    setState(() {
              ...
              Row(
                children: [
                  myContainer(Colors.pink, "Click pink", () {
                    setState(() {
                      myContainerColor = Colors.pink;
                    });
                  }),
                  myContainer(Colors.black, "Click black", () {
                    setState(() {
              ...
              Row(
                children: [
                  myContainer(Colors.orange, "Click orange", () {
                    setState(() {
                      myContainerColor = Colors.orange;
                    });
                  }),
                  myContainer(Colors.green, "Click green", () {
                    setState(() {
...
class myContainer extends StatelessWidget {
  ...
  myContainer(this.ContainerColor, this.mytext, this.Onpressed) {}
